...
public class NewsScreenActivity extends Activity {
    ...
    ArrayList<HashMap<String, String>> newsList;
 	JSONArray news = null;	
 	ListView list;
    LazyAdapter_news adapter;
	
	// URL to make request
	private static String url = "http://blikar.is/app/newsJSON.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter=new LazyAdapter_news(this, newsList); 
		...
		protected String doInBackground(String... args) {
	        ...
	        list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					String varNewsTitle = ((TextView) view.findViewById(R.id.newsTitle)).getText().toString();
					String varNewsPictureText = ((TextView) view.findViewById(R.id.newsPictureText)).getText().toString();
					String varArticle = ((TextView) view.findViewById(R.id.article)).getText().toString();
					
					// Starting new intent
					Intent in = new Intent(getApplicationContext(), SingleNewsActivity.class);
